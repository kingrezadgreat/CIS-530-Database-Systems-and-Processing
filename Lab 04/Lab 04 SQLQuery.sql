...
-- data for Project 4
insert into DEPENDENT values ( '453453453', 'Joe Anderson' ,'M',NULL,'Spouce');
...
insert into WORKS_ON values ( '888888888', '1', '32.5');
...
FROM EMPLOYEE E 
RIGHT OUTER JOIN DEPARTMENT D on D.Dnumber = E.Dno
LEFT OUTER JOIN EMPLOYEE S ON E.Super_ssn = S.SSN
...
FROM EMPLOYEE E, DEPENDENT Dp, WORKS_ON W
WHERE E.Sex = 'f' and Dp.Essn=E.Ssn and (SELECT COUNT(*) FROM WORKS_ON W WHERE W.Essn=E.Ssn)>=3
...
SELECT E.Lname, Dp.Relationship, D.Dname
FROM EMPLOYEE E, DEPARTMENT D, DEPENDENT Dp
WHERE E.Dno=D.Dnumber and D.Dname='Research' and Dp.Essn=E.Ssn and Dp.Relationship='Spouce' and 
(SELECT COUNT(*) FROM DEPENDENT Dp1 WHERE E.Ssn=Dp1.Essn and (Dp1.Relationship='son' or Dp1.Relationship='daughter'))=0


-- Q4

SELECT E.Lname, Dp.Relationship
FROM EMPLOYEE E, DEPENDENT Dp
WHERE Dp.Essn=E.Ssn and Dp.Relationship='Spouce' and 
(SELECT COUNT(*) FROM DEPENDENT Dp1 WHERE E.Ssn=Dp1.Essn and (Dp1.Relationship='son'))=0 and 
(SELECT COUNT(*) FROM DEPENDENT Dp1 WHERE E.Ssn=Dp1.Essn and (Dp1.Relationship='daughter'))>0


-- Q5

SELECT P.Pnumber, E.Lname, E.Ssn
FROM PROJECT P, EMPLOYEE E, WORKS_ON W
WHERE (SELECT COUNT(*) FROM WORKS_ON W, EMPLOYEE E WHERE P.Pnumber=W.Pno and W.Essn=E.Ssn and E.Sex='F' )>
(SELECT COUNT(*) FROM WORKS_ON W, EMPLOYEE E WHERE P.Pnumber=W.Pno and W.Essn=E.Ssn and E.Sex='M' ) and 
